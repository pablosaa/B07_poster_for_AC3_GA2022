...
\begin{itemize}
		...
		\item SAR based LF at 700~m spatial resolution are crucial, for this case study the same results cannot be reproduce by using passive SIC retrievals at 1~km resolution,
