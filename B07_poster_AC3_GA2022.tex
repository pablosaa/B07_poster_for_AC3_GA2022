...
\begin{poster}%
  ...
  % Authors
  {\vspace{+1em} \color{black}Pablo Saavedra~Garfias$^{1}$, Heike Kalesse-Los$^{1}$, Luisa von~Aldebyll$^{2}$, Hannes Griesche$^{3}$, Gunnar Spreen$^{4}$\\
  ...
  {% The makebox allows the title to flow into the logo, this is a hack
   % because of the L shaped logo.
    %\begin{tabular}{r}
   	%\vspace{+20em}\\
    \includegraphics[height=7.0em]{logo_small-ac3.png}
    %\end{tabular}   
  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{4.- Conclusions}{name=conclutions,column=0,span=2,below=results}{
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\small
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{[*] Contact}{name=contact, column=2, above=acknown}{
