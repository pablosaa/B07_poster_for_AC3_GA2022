...
\begin{tabular}{cc} %{@{}lcr@{}}
	...
	\colouredcircle {\larger Additional to the Cloudnet target classification (Fig.~\ref{fig:classification}, top), cloud base height (CBH) and top height (CTH) are estimated for up to three cloud layers.} To estimate CBH the Cloudnet pixels with liquid droplets or super-cooled liquid (SCL) are considered, for CTH the ice pixels are used in additon (Fig.~\ref{fig:closeup}).\\
\begin{tabular}{ccc}
	%\textbf{\Large COUPLED}	& \textbf{\Large DECOUPLED} \\
