...
\begin{poster}%
  ...
  {% The makebox allows the title to flow into the logo, this is a hack
   % because of the L shaped logo.
    %\begin{tabular}{r}
   	%\vspace{+20em}\\
    \includegraphics[height=7.1em]{logo_small-ac3.png}
    %\end{tabular}   
  }
...
\begin{minipage}{0.99\textwidth}
	...
	\centering
	%\subfloat{
		\includegraphics[width=.6\linewidth]{bias_sic_timeseries.png}\hfill
		\includegraphics[width=.37\linewidth]{mosaic0152_20191115T03271573_20191118T05301574_LF.png}
	%}
...
\begin{minipage}{0.9\textwidth}
	...
	\centering
	%\subfloat{
		\includegraphics[width=.62\linewidth]{new_drawing_lead_cloud.png}
	%}
...
\begin{tabular}{cc} %{@{}lcr@{}}
	...
	\begin{minipage}{0.5\linewidth}
		\begin{center}
			%\setcaptiontype{figure}
			\includegraphics[width=.75\linewidth]{cloudnet_measurements_20191118.png}\\
			\captionsetup{width=0.8\linewidth}
	...
	\begin{minipage}{0.4\linewidth}	
		\begin{center}             
			%\setcaptiontype{figure}
			\includegraphics[width=.7\linewidth]{cloudnet_classific_20191118.png}\\
			\includegraphics[width=.7\linewidth]{bulk_richardson_number_20191118.png}\\
			\captionsetup{width=0.9\linewidth}
			\captionof{figure}{Top: Cloudnet classification output from the measurements in Fig.~\ref{fig:measurements}. Bottom: bulk Richardson number for the lowest 1.5~km, with critical $Ri_b$=1 as threshold for PBLH. RS denotes times of radiosonde launches.}
...
\begin{tabular}{ccc}
	...
	\begin{minipage}{0.3\linewidth}
		\begin{center}
			...
			\captionof{figure}{Close-up of Fig.~\ref{fig:classification} (top) showing the PBLH (dashed-light-green), max~$\nabla WVT$ (green), and estimated cloud bottom and top heights (black lines) of the low-level stratiform mixed-phase cloud, the dotted-grey is the cloud base as detected by the ceilometer. Coupled status is shown along the x-axis.}
			\label{fig:closeup}
		\end{center}
	\end{minipage}
	&
...
From Fig.~\ref{fig:scatterWPLF} [a] a clear relationship of LWP and LF can be seen, the larger the LF the higher LWP, and the warmer the cloud top temperature too. For IWP (Fig.~\ref{fig:scatterWPLF} [b]) there is no relationship found, a wide range of IWP values occur during the observed LF. The only clear feature is the clustering of points with being gathered towards larger LF which corresponds to coupled cases as in Fig.~\ref{fig:cop-dec} (left \& middle).\\
\begin{tabular}{ll}
	\hspace{-1em}
	\begin{minipage}{0.65\linewidth}
		Shown in Fig.~\ref{fig:scatterWPLF} [c] is the gradient of cloud temperature defined as Eq.~\ref{eq:lapserate}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{4.- Conclusions}{name=conclutions,column=0,span=3,below=results}{
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\normalsize
\begin{itemize}
		\item Relating cloud observations with LF upwind with water vapour transport as conveying mechanism for the coupling seems to be plausible approach,
		\item A positive relationship of LWP and LF has been found; no clear relation between LF and IWP or cloud temperature gradient was found,
		\item Larger LF are acompanied by warmer cloud top, indicating a higher moisture content for those cases,
		\item It is confirmed that uncoupled clouds are mostly high level clouds, as also found for long-term observations at Utiqiaǵvik, Alaska~\refp{bib:garfias2021},
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{5.- References }{name=references,column=0, span=2, below=conclutions}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
